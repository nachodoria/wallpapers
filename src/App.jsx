          ...
          <div className='iteminfo'>
            ...
            <div className='itembot'>
              <div className='itembutton'>
                ...
                <button onClick={() => { goDetail("Wavy", "3.99", "src/main/wavy/phone.png", "src/main/wavy/desktop.png") }} className='buttonlearn'><span>Learn More</span></button>
          ...
          <div className='iteminfo'>
            ...
            <div className='itembot' style={{ flexDirection: "row-reverse" }}>
              <div className='itembutton'>
                ...
                <button onClick={() => { goDetail("Abstract", "3.99", "src/main/abstract/phone.png", "src/main/abstract/desktop.png") }} className='buttonlearn'><span>Learn More</span></button>
          ...
          <div className='iteminfo'>
            ...
            <div className='itembot'>
              <div className='itembutton'>
                ...
                <button onClick={() => { goDetail("Sonar", "2.99", "src/main/sonar/phone.png", "src/main/sonar/desktop.png") }} className='buttonlearn'><span>Learn More</span></button>
          ...
          <div className='iteminfo'>
            ...
            <div className='itembot' style={{ flexDirection: "row-reverse" }}>
              <div className='itembutton' >
                ...
                <button onClick={() => { goDetail("A Rush of Blood to the Head", "4.99", "src/main/arobtth/phone.png", "src/main/arobtth/desktop.png") }} className='buttonlearn'><span>Learn More</span></button>
